...
OANDA_ACCOUNT_ID_2 = os.getenv("OANDA_ACCOUNT_ID_2", "001-003-39389016-002")
OANDA_ACCOUNT_ID_3 = os.getenv("OANDA_ACCOUNT_ID_3", "001-003-39389016-003")
OANDA_ACCOUNT_ID_4 = os.getenv("OANDA_ACCOUNT_ID_4", "001-003-39389016-004")
