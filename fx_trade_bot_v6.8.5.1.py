...
from fx_trade_bot_utils import (
    ...
    open_oanda_order_simple as open_oanda_order, DynamicPositionManager as DPM, load_mc_legacy,
    calculate_stop_loss,
)
...
if PROFILE_MODULE == "config_bot_profile3":
    from fx_trade_bot_utils import DynamicPositionManager_v2 as DPM
elif PROFILE_MODULE == "config_bot_profile2":
    from fx_trade_bot_utils import DynamicPositionManager as DPM
